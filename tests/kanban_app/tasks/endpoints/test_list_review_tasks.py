...
from kanban_app.tasks.api.views import ReviewTasksView
...
def test_list_review_tasks_peformance_regressiorn(
    user,
    user_profile,
    second_user_profile,
    ...
    request = factory.get(REVIEW_TASKS_URL)

    force_authenticate(request, user=user)

    view = ReviewTasksView.as_view()
